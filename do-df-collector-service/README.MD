...
3 - Create a topic "do_processor_df_local". (We will send msg via this topic at first and project will consume msg from this topic)
<br/>
...
```
{"search": "ICMS", "date_ini": "2021-09-06", "date_end": "2021-10-21"}
```
