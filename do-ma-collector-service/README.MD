...
3 - Create a topic "do_processor_ma_local". (We will send msg via this topic at first and project will consume msg from this topic)
<br/>
...
docker exec -ti kafka-server1 \
  ...
  --replication-factor 1 \
  --partitions 1 \
  --topic do_processor_final_local
...
```
{"search": "something", "date_ini": "2021-09-10", "date_end": "2021-09-13"}
```
