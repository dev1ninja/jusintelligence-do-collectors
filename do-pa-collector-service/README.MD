...
3 - Create a topic "do_processor_pa_local". (We will send msg via this topic at first and project will consume msg from this topic)
<br/>
...
```
{"search": "OU", "date_ini": "2021-09-10", "date_end": "2021-09-20"}
```
