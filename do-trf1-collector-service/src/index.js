...
const port = 3000;
let microserviceName = "do-processor-trf1";
...
springCloudConfigClient.load({
  ...
  .then(config => {
    ...
    // })
    const consume = async () => require("./listener/listener-search-url")(config, '{"search": "something", "date_ini": "2021-09-06", "date_end": "2021-10-21"}', ambiente)
    consume();
    app.listen(port, () =>
