...
const port = 3000;
let microserviceName = "do-processor-trf3";
...
springCloudConfigClient.load({
  ...
  .then(config => {
    ...
    // })
    const consume = async () => require("./listener/listener-search-url")(config, '{"search": "something", "date_ini": "2021-10-11", "date_end": "2021-10-18"}', ambiente)
    consume();
    // app.listen(port, () =>
