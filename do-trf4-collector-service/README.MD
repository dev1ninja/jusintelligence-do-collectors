...
3 - Create a topic "do_processor_trf4_local". (We will send msg via this topic at first and project will consume msg from this topic)
<br/>
...
```
{"search": "something", "date_ini": "2021-10-11", "date_end": "2021-10-18"}
```
